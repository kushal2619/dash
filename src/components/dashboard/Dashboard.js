...
class Dashboard extends Component {
  ...
  submitHandler = (event) => {
    ...
    this.interval = setInterval(() => {
      if ((this.state.flag === true) && (!(this.state.tickerValue==='BANKNIFTY' && this.state.strikeDistanceValue===50)) ) {
        this.setState({
          flag: false,
        });
      ...
      <div>
        <nav className="navbar navbar-expand navbar-dark bg-dark sticky-top">
          <div className="container-fluid">
            ...
            <Dropdown>
              <Dropdown.Toggle style={{borderRadius: '50%', padding: '0px', background: 'rgb(204, 204, 204)', border: '0px'}}>
                <img src={op1} alt="optionMenu" className="optionMenuImage"/>
              </Dropdown.Toggle>
              <Dropdown.Menu>
                {this.tokenKeyForm()}
              </Dropdown.Menu>
